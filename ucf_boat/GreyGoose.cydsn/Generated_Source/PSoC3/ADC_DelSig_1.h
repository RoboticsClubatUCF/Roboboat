...
typedef struct ADC_DelSig_1_backupStruct 
{
    uint8 enableState;
    uint8 deccr;
...
/* only valid for PSoCA */
    ...
    typedef struct ADC_DelSig_1_powerModeBackupStruct 
    {
        uint8 DSM_CR_14;
        uint8 DSM_CR_15;
        uint8 DSM_CR_16;
        ...
        /* field to decide whether or not to save the registers 
           in the stop API*/
        uint8 bypassRestore;
    }   ADC_DelSig_1_POWERMODE_BACKUP_STRUCT;
#endif /* CY_PSOC5A */
...
void ADC_DelSig_1_GainCompensation(uint8 inputRange, uint16 IdealDecGain, uint16 IdealOddDecGain, uint8 resolution)\
                                              ;
#if (CY_PSOC5A)
...
#define ADC_DelSig_1_CFG1        1
#define ADC_DelSig_1_CFG2        2
#define ADC_DelSig_1_CFG3        3
#define ADC_DelSig_1_CFG4        4
...
#if (CY_PSOC5A)
    #define ADC_DelSig_1_BYPASS_ENABLED                    (0x01u)
    #define ADC_DelSig_1_BYPASS_DISABLED                   (0x00u)
#endif /* CY_PSOC5A */
...
/* Trim value defines */
    ...
    #define ADC_DelSig_1_DEC_TRIM_VREF_DIFF_8_15        (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__M5))
    #define ADC_DelSig_1_DEC_TRIM_VREF_DIFF_16_20       (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__M1))
    #define ADC_DelSig_1_DEC_TRIM_VREF_2_DIFF_8_15      (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__M6))
    #define ADC_DelSig_1_DEC_TRIM_VREF_2_DIFF_16_20     (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__M2))
    #define ADC_DelSig_1_DEC_TRIM_VREF_4_DIFF_8_15      (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__M7))
    #define ADC_DelSig_1_DEC_TRIM_VREF_4_DIFF_16_20     (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__M3))
    #define ADC_DelSig_1_DEC_TRIM_VREF_16_DIFF_8_15     (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__M8))
    #define ADC_DelSig_1_DEC_TRIM_VREF_16_DIFF_16_20    (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__M4))
#elif (CY_PSOC5A)
    #define ADC_DelSig_1_DEC_TRIM_VREF_DIFF_8_15        (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__16L))
    #define ADC_DelSig_1_DEC_TRIM_VREF_DIFF_16_20       (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__1L))
    #define ADC_DelSig_1_DEC_TRIM_VREF_2_DIFF_8_15      (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__16H))
    #define ADC_DelSig_1_DEC_TRIM_VREF_2_DIFF_16_20     (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__1H))
    #define ADC_DelSig_1_DEC_TRIM_VREF_4_DIFF_8_15      (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__P25L))
    #define ADC_DelSig_1_DEC_TRIM_VREF_4_DIFF_16_20     (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__4L))
    #define ADC_DelSig_1_DEC_TRIM_VREF_16_DIFF_8_15     (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__P25H))
    #define ADC_DelSig_1_DEC_TRIM_VREF_16_DIFF_16_20    (CY_GET_XTND_REG8(ADC_DelSig_1_DEC__TRIM__4H))
...
#define ADC_DelSig_1_DSM_CR0_REG              (* (reg8 *) ADC_DelSig_1_DSM4__CR0 )
#define ADC_DelSig_1_DSM_CR0_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__CR0 )

#define ADC_DelSig_1_DSM_CR1_REG              (* (reg8 *) ADC_DelSig_1_DSM4__CR1 )
#define ADC_DelSig_1_DSM_CR1_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__CR1 )

#define ADC_DelSig_1_DSM_CR2_REG              (* (reg8 *) ADC_DelSig_1_DSM4__CR2 )
#define ADC_DelSig_1_DSM_CR2_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__CR2 )

#define ADC_DelSig_1_DSM_CR3_REG              (* (reg8 *) ADC_DelSig_1_DSM4__CR3 )
#define ADC_DelSig_1_DSM_CR3_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__CR3 )

#define ADC_DelSig_1_DSM_CR4_REG              (* (reg8 *) ADC_DelSig_1_DSM4__CR4 )
#define ADC_DelSig_1_DSM_CR4_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__CR4 )

#define ADC_DelSig_1_DSM_CR5_REG              (* (reg8 *) ADC_DelSig_1_DSM4__CR5 )
#define ADC_DelSig_1_DSM_CR5_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__CR5 )

#define ADC_DelSig_1_DSM_CR6_REG              (* (reg8 *) ADC_DelSig_1_DSM4__CR6 )
#define ADC_DelSig_1_DSM_CR6_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__CR6 )

#define ADC_DelSig_1_DSM_CR7_REG              (* (reg8 *) ADC_DelSig_1_DSM4__CR7 )
#define ADC_DelSig_1_DSM_CR7_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__CR7 )

#define ADC_DelSig_1_DSM_CR8_REG              (* (reg8 *) ADC_DelSig_1_DSM4__CR8 )
#define ADC_DelSig_1_DSM_CR8_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__CR8 )

#define ADC_DelSig_1_DSM_CR9_REG              (* (reg8 *) ADC_DelSig_1_DSM4__CR9 )
#define ADC_DelSig_1_DSM_CR9_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__CR9 )

#define ADC_DelSig_1_DSM_CR10_REG             (* (reg8 *) ADC_DelSig_1_DSM4__CR10 )
#define ADC_DelSig_1_DSM_CR10_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__CR10 )

#define ADC_DelSig_1_DSM_CR11_REG             (* (reg8 *) ADC_DelSig_1_DSM4__CR11 )
#define ADC_DelSig_1_DSM_CR11_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__CR11 )

#define ADC_DelSig_1_DSM_CR12_REG             (* (reg8 *) ADC_DelSig_1_DSM4__CR12 )
#define ADC_DelSig_1_DSM_CR12_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__CR12 )

#define ADC_DelSig_1_DSM_CR13_REG             (* (reg8 *) ADC_DelSig_1_DSM4__CR13 )
#define ADC_DelSig_1_DSM_CR13_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__CR13 )

#define ADC_DelSig_1_DSM_CR14_REG             (* (reg8 *) ADC_DelSig_1_DSM4__CR14 )
#define ADC_DelSig_1_DSM_CR14_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__CR14 )

#define ADC_DelSig_1_DSM_CR15_REG             (* (reg8 *) ADC_DelSig_1_DSM4__CR15 )
#define ADC_DelSig_1_DSM_CR15_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__CR15 )

#define ADC_DelSig_1_DSM_CR16_REG             (* (reg8 *) ADC_DelSig_1_DSM4__CR16 )
#define ADC_DelSig_1_DSM_CR16_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__CR16 )

#define ADC_DelSig_1_DSM_CR17_REG             (* (reg8 *) ADC_DelSig_1_DSM4__CR17 )
#define ADC_DelSig_1_DSM_CR17_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__CR17 )

#define ADC_DelSig_1_DSM_REF0_REG             (* (reg8 *) ADC_DelSig_1_DSM4__REF0 )
#define ADC_DelSig_1_DSM_REF0_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__REF0 )

#define ADC_DelSig_1_DSM_REF1_REG             (* (reg8 *) ADC_DelSig_1_DSM4__REF1 )
#define ADC_DelSig_1_DSM_REF1_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__REF1 )

#define ADC_DelSig_1_DSM_REF2_REG             (* (reg8 *) ADC_DelSig_1_DSM4__REF2 )
#define ADC_DelSig_1_DSM_REF2_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__REF2 )

#define ADC_DelSig_1_DSM_REF3_REG             (* (reg8 *) ADC_DelSig_1_DSM4__REF3 )
#define ADC_DelSig_1_DSM_REF3_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__REF3 )

#define ADC_DelSig_1_DSM_DEM0_REG             (* (reg8 *) ADC_DelSig_1_DSM4__DEM0 )
#define ADC_DelSig_1_DSM_DEM0_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__DEM0 )

#define ADC_DelSig_1_DSM_DEM1_REG             (* (reg8 *) ADC_DelSig_1_DSM4__DEM1 )
#define ADC_DelSig_1_DSM_DEM1_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__DEM1 )

#define ADC_DelSig_1_DSM_MISC_REG             (* (reg8 *) ADC_DelSig_1_DSM4__MISC )
#define ADC_DelSig_1_DSM_MISC_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__MISC )

#define ADC_DelSig_1_DSM_CLK_REG              (* (reg8 *) ADC_DelSig_1_DSM4__CLK )
#define ADC_DelSig_1_DSM_CLK_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__CLK )

#define ADC_DelSig_1_DSM_TST0_REG             (* (reg8 *) ADC_DelSig_1_DSM4__TST0 )
#define ADC_DelSig_1_DSM_TST0_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__TST0 )

#define ADC_DelSig_1_DSM_TST1_REG             (* (reg8 *) ADC_DelSig_1_DSM4__TST1 )
#define ADC_DelSig_1_DSM_TST1_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__TST1 )

#define ADC_DelSig_1_DSM_BUF0_REG             (* (reg8 *) ADC_DelSig_1_DSM4__BUF0 )
#define ADC_DelSig_1_DSM_BUF0_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__BUF0 )

#define ADC_DelSig_1_DSM_BUF1_REG             (* (reg8 *) ADC_DelSig_1_DSM4__BUF1 )
#define ADC_DelSig_1_DSM_BUF1_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__BUF1 )

#define ADC_DelSig_1_DSM_BUF2_REG             (* (reg8 *) ADC_DelSig_1_DSM4__BUF2 )
#define ADC_DelSig_1_DSM_BUF2_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__BUF2 )

#define ADC_DelSig_1_DSM_BUF3_REG             (* (reg8 *) ADC_DelSig_1_DSM4__BUF3 )
#define ADC_DelSig_1_DSM_BUF3_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__BUF3 )

#define ADC_DelSig_1_DSM_OUT0_REG             (* (reg8 *) ADC_DelSig_1_DSM4__OUT0 )
#define ADC_DelSig_1_DSM_OUT0_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__OUT0 )

#define ADC_DelSig_1_DSM_OUT1_REG             (* (reg8 *) ADC_DelSig_1_DSM4__OUT1 )
#define ADC_DelSig_1_DSM_OUT1_PTR             (  (reg8 *) ADC_DelSig_1_DSM4__OUT1 )

#define ADC_DelSig_1_DSM_SW0_REG              (* (reg8 *) ADC_DelSig_1_DSM4__SW0 )
#define ADC_DelSig_1_DSM_SW0_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__SW0 )

#define ADC_DelSig_1_DSM_SW2_REG              (* (reg8 *) ADC_DelSig_1_DSM4__SW2 )
#define ADC_DelSig_1_DSM_SW2_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__SW2 )

#define ADC_DelSig_1_DSM_SW3_REG              (* (reg8 *) ADC_DelSig_1_DSM4__SW3 )
#define ADC_DelSig_1_DSM_SW3_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__SW3 )

#define ADC_DelSig_1_DSM_SW4_REG              (* (reg8 *) ADC_DelSig_1_DSM4__SW4 )
#define ADC_DelSig_1_DSM_SW4_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__SW4 )

#define ADC_DelSig_1_DSM_SW6_REG              (* (reg8 *) ADC_DelSig_1_DSM4__SW6 )
#define ADC_DelSig_1_DSM_SW6_PTR              (  (reg8 *) ADC_DelSig_1_DSM4__SW6 )
...
#elif (CY_PSOC5A)
    #define ADC_DelSig_1_PWRMGR_DSM_REG       (* (reg8 *) CYDEV_PM_AVAIL_CR5 )  /* Modulator Power manager */
    #define ADC_DelSig_1_PWRMGR_DSM_PTR       (  (reg8 *) CYDEV_PM_AVAIL_CR5 )  /* Modulator Power manager */
#endif /* CY_PSOC5A */
...
#elif (CY_PSOC5A)
    #define ADC_DelSig_1_RESET_CR1_REG                    (* (reg8 *) CYDEV_RESET_CR1)
    #define ADC_DelSig_1_RESET_CR1_PTR                    (  (reg8 *) CYDEV_RESET_CR1)

    #define ADC_DelSig_1_RESET_CR3_REG                    (* (reg8 *) CYDEV_RESET_CR3)
    #define ADC_DelSig_1_RESET_CR3_PTR                    (  (reg8 *) CYDEV_RESET_CR3)
...
/* ADC_DelSig_1_CFG1 Clock: 2590000 Hz */
...
#define ADC_DelSig_1_CFG1_CLOCK_FREQ         (2590000u)
#define ADC_DelSig_1_CFG1_CP_CLOCK_FREQ      (10360000u)
#define ADC_DelSig_1_CFG1_REFERENCE_VOLTAGE  (1.0240)
#define ADC_DelSig_1_CFG1_COUNTS_PER_VOLT    (64000u)
#define ADC_DelSig_1_CFG1_IDEAL_DEC_GAIN     (0X90DBu)
...
/* ADC_DelSig_1_CFG2 Conversion Mode: 1 */
/* ADC_DelSig_1_CFG2 Input Buffer Gain: 1   */
/* ADC_DelSig_1_CFG2 Reference: 0 */
/* ADC_DelSig_1_CFG2 Input Range: 3  */
/* ADC_DelSig_1_CFG2 Resolution: 16 bits */
/* ADC_DelSig_1_CFG2 Clock: 2590000 Hz */

#define ADC_DelSig_1_CFG2_DEC_CR             (0X34u)
...
#define ADC_DelSig_1_CFG2_DSM_CR5            (0X0Au)
#define ADC_DelSig_1_CFG2_DSM_CR6            (0X3Cu)
#define ADC_DelSig_1_CFG2_DSM_CR7            (0X00u)
#define ADC_DelSig_1_CFG2_DSM_CR8            (0X12u)
#define ADC_DelSig_1_CFG2_DSM_CR9            (0X13u)
#define ADC_DelSig_1_CFG2_DSM_CR10           (0X44u)
#define ADC_DelSig_1_CFG2_DSM_CR11           (0X48u)
#define ADC_DelSig_1_CFG2_DSM_CR12           (0X01u)
#define ADC_DelSig_1_CFG2_DSM_CR13           (0X00u)
#define ADC_DelSig_1_CFG2_DSM_CR14           (0X02u)
#define ADC_DelSig_1_CFG2_DSM_CR15           (0X12u)
#define ADC_DelSig_1_CFG2_DSM_CR16           (0X28u)
#define ADC_DelSig_1_CFG2_DSM_CR17           (0XEBu)
...
#define ADC_DelSig_1_CFG2_CLOCKS_PER_SAMPLE  (0X0103u)
#define ADC_DelSig_1_CFG2_CLOCK_FREQ         (2590000u)
#define ADC_DelSig_1_CFG2_CP_CLOCK_FREQ      (10360000u)
#define ADC_DelSig_1_CFG2_REFERENCE_VOLTAGE  (1.0240)
#define ADC_DelSig_1_CFG2_COUNTS_PER_VOLT    (10667u)
#define ADC_DelSig_1_CFG2_RESOLUTION         (16u)
#define ADC_DelSig_1_CFG2_CONVMODE           (1u)
#define ADC_DelSig_1_CFG2_IDEAL_DEC_GAIN     (0X814Au)
#define ADC_DelSig_1_CFG2_INPUT_RANGE        (3u)
#define ADC_DelSig_1_CFG2_INPUT_RANGE_VALUE  (6.144)

#define ADC_DelSig_1_CFG2_INPUT_MODE         (1u)
#define ADC_DelSig_1_CFG2_REFERENCE          (0u)
#define ADC_DelSig_1_CFG2_BUFFER_GAIN        (1u)

/* Input and DAC Cap values in pF */
#define ADC_DelSig_1_CFG2_IPCAP1VALUE        (0X03E0u)
#define ADC_DelSig_1_CFG2_DACAPVALUE         (0X1770u)
...
#define ADC_DelSig_1_CFG3_DSM_CR8            (0X12u)
#define ADC_DelSig_1_CFG3_DSM_CR9            (0X13u)
...
#define ADC_DelSig_1_CFG3_DSM_BUF2           (0X01u)
...
#define ADC_DelSig_1_CFG3_COUNTS_PER_VOLT    (64000u)
#define ADC_DelSig_1_CFG3_RESOLUTION         (16u)
#define ADC_DelSig_1_CFG3_CONVMODE           (2u)
#define ADC_DelSig_1_CFG3_IDEAL_DEC_GAIN     (0X90DBu)
#define ADC_DelSig_1_CFG3_INPUT_RANGE        (0u)
#define ADC_DelSig_1_CFG3_INPUT_MODE         (1u)
...
#define ADC_DelSig_1_CFG4_DSM_CR8            (0X12u)
#define ADC_DelSig_1_CFG4_DSM_CR9            (0X13u)
...
#define ADC_DelSig_1_CFG4_DSM_BUF2           (0X01u)
...
#define ADC_DelSig_1_CFG4_COUNTS_PER_VOLT    (64000u)
#define ADC_DelSig_1_CFG4_RESOLUTION         (16u)
#define ADC_DelSig_1_CFG4_CONVMODE           (2u)
#define ADC_DelSig_1_CFG4_IDEAL_DEC_GAIN     (0X90DBu)
#define ADC_DelSig_1_CFG4_INPUT_RANGE        (0u)
#define ADC_DelSig_1_CFG4_INPUT_MODE         (1u)
