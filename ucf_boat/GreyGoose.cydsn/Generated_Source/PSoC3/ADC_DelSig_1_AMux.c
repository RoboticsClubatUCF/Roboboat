...
uint8 ADC_DelSig_1_AMux_lastChannel = ADC_DelSig_1_AMux_NULL_CHANNEL;


/*******************************************************************************
* Function Name: ADC_DelSig_1_AMux_Start
********************************************************************************
* Summary:
...
void ADC_DelSig_1_AMux_Start(void)
{
    ...
    for(chan = 0; chan < ADC_DelSig_1_AMux_CHANNELS ; chan++)
    {
#if(ADC_DelSig_1_AMux_MUXTYPE == ADC_DelSig_1_AMux_MUX_SINGLE)
        ADC_DelSig_1_AMux_Unset(chan);
#else
...
/*******************************************************************************
* Function Name: ADC_DelSig_1_AMux_Select
********************************************************************************
* Summary:
...
{
    ADC_DelSig_1_AMux_DisconnectAll();        /* Disconnect all previous connections */
    ADC_DelSig_1_AMux_Connect(channel);       /* Make the given selection */
    ADC_DelSig_1_AMux_lastChannel = channel;  /* Update last channel */
}
#endif


/*******************************************************************************
* Function Name: ADC_DelSig_1_AMux_FastSelect
********************************************************************************
* Summary:
...
#if(ADC_DelSig_1_AMux_MUXTYPE == ADC_DelSig_1_AMux_MUX_DIFF)
#if(!ADC_DelSig_1_AMux_ATMOSTONE)
/*******************************************************************************
