...
{
    if (ADC_DelSig_1_theACLK_CLKEN & ADC_DelSig_1_theACLK_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void ADC_DelSig_1_theACLK_SetModeRegister(uint8 clkMode) 
{
    ADC_DelSig_1_theACLK_MOD_SRC |= clkMode & ADC_DelSig_1_theACLK_MODE_MASK;
}
...
*
*******************************************************************************/
void ADC_DelSig_1_theACLK_ClearModeRegister(uint8 clkMode) 
{
    ADC_DelSig_1_theACLK_MOD_SRC &= ~clkMode | ~ADC_DelSig_1_theACLK_MODE_MASK;
}
...
{
    return ADC_DelSig_1_theACLK_MOD_SRC & ADC_DelSig_1_theACLK_MODE_MASK;
}
...
void ADC_DelSig_1_theACLK_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        ADC_DelSig_1_theACLK_MOD_SRC =
            (ADC_DelSig_1_theACLK_MOD_SRC & ~ADC_DelSig_1_theACLK_SRC_SEL_MSK) | clkSource;
    }
